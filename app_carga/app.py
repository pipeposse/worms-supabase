...
"""
        ...
        if _panel.empty:
            ...
            _t = _t[["codigo", "nombre", "tipo_tanque", "sector", "producto_principal", "Medidor", "wedo_label",
                     "intervalo_real_min", "nivel_pct_actual", "_litros", "_tn", "capacidad_litros", "ultima_medicion"]].rename(columns={
            ...
            st.caption("Stock en **litros** (medición real). El **kg/TN** se calcula por densidad del producto del tanque. "
                       "**Intervalo (min)** = cada cuánto reporta el sensor (no todos a la vez). "
            ...
            st.divider()
            g_cargar, g_editar, g_hist = st.tabs(["✍️ Cargar medición (manual)", "✏️ Editar tanque", "📈 Histórico / variación"])
