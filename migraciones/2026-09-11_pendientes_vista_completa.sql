...
base AS (
    ...
    UNION ALL
    -- Un mismo ticket cargado varias veces al mismo tanque: kg fantasma en el ledger.
    -- Lo detectó el ticket 6653 (5 confirmaciones en 1 segundo, 26.320 kg de más).
    SELECT tipo, ref, marca, prioridad, titulo, detalle, seccion, vista,
           sector_nav, id_batch, op, cuando, n
    FROM produccion.v_pendientes_mov_duplicado
